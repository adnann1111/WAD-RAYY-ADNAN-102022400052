...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
   ...
   Route::get('/books/{book}/edit',[BookController::class, 'edit'])->name('admin.edit');
   Route::put('/books/{book}',[BookController::class, 'update'])->name('admin.update');
   Route::delete('/books/{book}',[BookController::class, 'destroy'])->name('admin.destroy');
});
